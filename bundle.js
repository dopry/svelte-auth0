...
var app = (function () {
    ...
    // (16:0) <Auth0Context   domain="dev-hvw40i79.auth0.com"   client_id="aOijZt2ug6Ovgzp0HXdF23B6zxwA6PaP"   audience="http://localhost:5000"   callback_url="http://localhost:5000"   logout_url="http://localhost:5000" >
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 23, 2, 424);
    			attr_dev(button1, "class", "btn");
    			add_location(button1, file, 24, 2, 504);
    			add_location(th0, file, 27, 10, 616);
    			add_location(th1, file, 27, 24, 630);
    			add_location(tr0, file, 27, 6, 612);
    			add_location(thead, file, 26, 4, 598);
    			add_location(td0, file, 30, 10, 685);
    			add_location(td1, file, 30, 28, 703);
    			add_location(tr1, file, 30, 6, 681);
    			add_location(td2, file, 31, 10, 740);
    			add_location(td3, file, 31, 34, 764);
    			add_location(tr2, file, 31, 6, 736);
    			add_location(td4, file, 32, 10, 807);
    			add_location(td5, file, 32, 28, 825);
    			add_location(tr3, file, 32, 6, 803);
    			add_location(td6, file, 33, 10, 862);
    			add_location(td7, file, 33, 26, 878);
    			add_location(tr4, file, 33, 6, 858);
    			add_location(td8, file, 34, 10, 913);
    			add_location(pre, file, 34, 31, 934);
    			add_location(td9, file, 34, 27, 930);
    			add_location(tr5, file, 34, 6, 909);
    			add_location(td10, file, 35, 10, 1002);
    			add_location(td11, file, 35, 28, 1020);
    			add_location(tr6, file, 35, 6, 998);
    			add_location(tbody, file, 29, 4, 667);
    			add_location(table, file, 25, 2, 586);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(16:0) <Auth0Context   domain=\\\"dev-hvw40i79.auth0.com\\\"   client_id=\\\"aOijZt2ug6Ovgzp0HXdF23B6zxwA6PaP\\\"   audience=\\\"http://localhost:5000\\\"   callback_url=\\\"http://localhost:5000\\\"   logout_url=\\\"http://localhost:5000\\\" >",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 40, 0, 1088);
    			attr_dev(a0, "href", "https://auth0.com/docs/universal-login/new");
    			add_location(a0, file, 43, 6, 1297);
    			add_location(li0, file, 43, 2, 1293);
    			attr_dev(a1, "href", "https://auth0.com/docs/connections/social/google");
    			add_location(a1, file, 44, 6, 1410);
    			add_location(li1, file, 44, 2, 1406);
    			add_location(ol, file, 42, 0, 1286);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 14, 0, 189);
    		},
    		l: function claim(nodes) {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, $authError, $userInfo, $idToken, $authToken, $isAuthenticated, $isLoading*/ 319) {
